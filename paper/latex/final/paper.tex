...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    process/.style={draw, rounded corners=4pt, fill=flowgray, minimum width=2cm,
                 minimum height=0.6cm, align=center, font=\scriptsize},
    decision/.style={draw, diamond, fill=bandamber!50, minimum width=1.4cm,
                     minimum height=0.7cm, align=center, font=\scriptsize,
                     inner sep=1pt, aspect=2},
    action/.style={draw, rounded corners=4pt, fill=coordblue!20, minimum width=1.6cm,
                   minimum height=0.5cm, align=center, font=\scriptsize},
    result/.style={draw, rounded corners=4pt, fill=bandgreen!70, minimum width=1.6cm,
                   minimum height=0.5cm, align=center, font=\scriptsize},
    arr/.style={-{Stealth[length=4pt]}, thick},
  ]
    \node[process] (measure) {Measure\\metrics};
    \node[decision, below=of measure] (checkcoord) {Coord $< 0.3$?};
    \node[action, right=1.4cm of checkcoord] (bind) {BIND};
    \node[process, below=0.4cm of bind] (remeasure) {\scriptsize Remeasure};
    \node[decision, below=1cm of checkcoord] (checkgate) {Gated $> 0.6$?};
    \node[action, right=1.4cm of checkgate] (veil) {VEIL};
    \node[decision, below=of checkgate] (stable) {Stable?};
    \node[result, below left=0.5cm and 0cm of stable] (converge) {CONVERGE};
    \node[process, below right=0.5cm and 0cm of stable] (cont) {Continue\\cycle};

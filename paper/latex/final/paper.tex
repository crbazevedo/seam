...
\begin{figure}[t]
  ...
  \begin{tikzpicture}[
    ...
    proc/.style={draw, rounded corners=3pt, fill=flowgray, minimum width=3.6cm,
                 minimum height=0.55cm, align=center, font=\scriptsize},
    action/.style={draw, rounded corners=3pt, fill=coordblue!15, minimum width=3.6cm,
                   minimum height=0.55cm, align=center, font=\scriptsize},
    result/.style={draw, rounded corners=3pt, fill=bandgreen!60, minimum width=3.6cm,
                   minimum height=0.55cm, align=center, font=\scriptsize\bfseries},
    loop/.style={draw, rounded corners=3pt, fill=bandamber!30, minimum width=3.6cm,
                 minimum height=0.55cm, align=center, font=\scriptsize},
